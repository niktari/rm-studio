...
const firstDivLetters = document.querySelectorAll(".letters-container.first div");
const secondDivLetters = document.querySelectorAll(".letters-container.second div");
...
function translateDivs(e) {
            ...
            let mappedTranslateX = map(e.clientY, 0, window.innerHeight, transformAmounts[index], transformAmounts[index] * -1);
